...
sips -z 64 64  "$imageName" --out "$iconset/icon_32x32@2x.png"
sips -z 128 128  "$imageName" --out "$iconset/icon_128x128.png"
sips -z 256 256  "$imageName" --out "$iconset/icon_128x128@2x.png"
sips -z 256 256  "$imageName" --out "$iconset/icon_256x256.png"
